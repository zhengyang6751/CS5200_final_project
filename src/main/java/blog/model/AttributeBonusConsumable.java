...
public class AttributeBonusConsumable {
    ...
    public AttributeBonusConsumable(String itemName, int strengthBonus, int dexterityBonus, int vitalityBonus,
    ...
    public String toString() {
        return "AttributeBonusConsumable [itemName=" + itemName + ", strengthBonus=" + strengthBonus
                + ", dexterityBonus=" + dexterityBonus + ", vitalityBonus=" + vitalityBonus + ", intelligenceBonus="
                + intelligenceBonus + ", mindBonus=" + mindBonus + "]";
    }
