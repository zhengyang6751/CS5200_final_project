...
public class AttributeBonusWeapon {
    ...
    public AttributeBonusWeapon(String itemName, int strengthBonus, int dexterityBonus, int vitalityBonus,
    ...
    public String toString() {
        return "AttributeBonusWeapon [itemName=" + itemName + ", strengthBonus=" + strengthBonus + ", dexterityBonus="
